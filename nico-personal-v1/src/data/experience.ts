export interface SelectedWork {
  thumbnail?: string
  thumbnailAlt?: string
  coverLayout?: 'landscape' | 'portrait'
  tags?: string[]
  title: string
  creator?: string
  category: 'KOL' | 'KOC'
...
const selectedWorkCovers: Pick<SelectedWork, 'thumbnail' | 'thumbnailAlt' | 'coverLayout' | 'tags'>[] = [
  {thumbnail:'/assets/selected-work/jackery-kol-family-garden.jpg',thumbnailAlt:'Family Garden Jackery creator campaign'},
  {thumbnail:'/assets/selected-work/jackery-kol-fridge-guard-instagram.png',thumbnailAlt:'Spanish Family Fridge Guard campaign',coverLayout:'portrait'},
  {thumbnail:'/assets/selected-work/jackery-kol-diy-offgrid.jpg',thumbnailAlt:'DIY Off-Grid Jackery creator campaign'},
  {thumbnail:'/assets/selected-work/jackery-koc-gpu-mining.jpg',thumbnailAlt:'GPU Mining Jackery KOC content',tags:['CREATIVE USE-CASE','CROSS-VERTICAL','PRODUCT INTEGRATION']},
  {thumbnail:'/assets/selected-work/jackery-koc-offgrid-cabin.jpg',thumbnailAlt:'Off-Grid Cabin Jackery product review',tags:['REAL-LIFE USE','OFF-GRID','PRODUCT REVIEW']},
]
export const experienceEntries: ExperienceEntry[] = [
  ...
  ].map((work, index) => ({...work, category: work.category as 'KOL' | 'KOC', ...selectedWorkCovers[index]})), highlights: [
